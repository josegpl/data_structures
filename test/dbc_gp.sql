...
CREATE TABLE `gp` (
  `cod_gp` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `nome` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`cod_gp`),
  UNIQUE KEY `cod_gp` (`cod_gp`)
...
INSERT INTO `gp` VALUES (1,'interlagos'),(2,'monaco'),(3,'franca');
...
-- Dump completed on 2018-06-27  2:01:24
