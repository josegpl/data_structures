...
CREATE TABLE `corrida` (
  `cod_corrida` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `dat` date DEFAULT NULL,
  `cod_temp` bigint(20) unsigned DEFAULT NULL,
  `cod_auto` bigint(20) unsigned DEFAULT NULL,
  PRIMARY KEY (`cod_corrida`),
  UNIQUE KEY `cod_corrida` (`cod_corrida`),
  KEY `cod_temp` (`cod_temp`),
  CONSTRAINT `corrida_ibfk_1` FOREIGN KEY (`cod_temp`) REFERENCES `temporada` (`cod_temp`)
...
INSERT INTO `corrida` VALUES (1,'2018-06-27',1,1),(2,'2018-06-29',1,2),(3,'2018-07-02',1,3);
...
-- Dump completed on 2018-06-27  2:01:26
