...
CREATE TABLE `compete` (
  ...
  CONSTRAINT `compete_ibfk_1` FOREIGN KEY (`cod_temp`) REFERENCES `temporada` (`cod_temp`),
  CONSTRAINT `compete_ibfk_2` FOREIGN KEY (`cod_equipe`) REFERENCES `equipe` (`cod_equipe`)
...
INSERT INTO `compete` VALUES (1,1,10),(1,2,25),(1,1,10),(1,2,25),(1,3,13);
...
-- Dump completed on 2018-06-27  2:01:31
